...
namespace TallAndSassy\PluginGrok\Tests;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Facades\Route;
use Orchestra\Testbench\TestCase as Orchestra;
use TallAndSassy\PluginGrok\PluginGrokServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    public function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'TallAndSassy\\PluginGrok\\Database\\Factories\\'.class_basename($modelName).'Factory'
        );

        // route prefix
        // this must match/sync with what was put in
        // tests/Feature/Http/Controllers/PluginGrokControllerTest.php/setup
    ...
    {
        return [
            PluginGrokServiceProvider::class,
        ];
    }
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        include_once __DIR__.'/../database/migrations/create_plugin_grok_table.php';
        (new \CreatePluginGrokTable())->up();
    }
}
